...
/* This program was last updated 17 Sept 2007 by John T. Wodder II. */
...
int main(int argc, char** argv) {
 ...
 if (!flags.eval) {
  ...
  char* s; size_t len;
  while (s = fgetln(bf, &len)) {s[len-1] = 0; appendLine(s); }
  fclose(bf);
 }
