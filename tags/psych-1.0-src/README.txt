...
output.
	...
	Psych was written by John T. Wodder II (minimiscience@users.
sourceforge.net) and is licensed under the GNU GPL, version 3 or later.  The
location of the current Psych tarball will probably be subject to change a bit,
though if you have access to a Gopher client, you should be able to find the
current source at: gopher://sdf.lonestar.org/99/users/jwodder/src/psych-src.tgz
